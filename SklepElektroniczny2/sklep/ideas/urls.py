...
urlpatterns = [
    ...
    path('sklep_elektroniczny/<int:pk>', views.sklep_elektronicznyDetail.as_view(), name=views.sklep_elektronicznyDetail.name),
    path('produkt', views.produktList.as_view(), name=views.produktList.name),
    path('produkt/<int:pk>', views.produktDetail.as_view(), name=views.klientDetail.name),
